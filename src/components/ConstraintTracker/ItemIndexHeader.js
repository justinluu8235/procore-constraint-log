    ...
    render(){
        return(
            <div class="header-bar">
                ...
                <a href="/"><h1 class="header-title">Constraint Trackers </h1></a>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-qa="ci-ChevronRight" name="ChevronRight" focusable="false" ><path d="M16.75 12L10.3964 5.64641L8.63309 7.40977L13.2133 12L8.63309 16.5902L10.3964 18.3535L16.75 12Z" fill="currentColor"></path></svg>
